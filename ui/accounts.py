...
class AccountsView(ctk.CTkFrame):
    ...
    def __init__(self, master):
        ...
        oauth_frame.grid(row=1, column=0, padx=20, pady=10, sticky="ew")
        ...
        self.btn_conectar.pack(padx=15, pady=15)

        self.lista = ctk.CTkScrollableFrame(self)
        self.lista.grid(row=3, column=0, padx=20, pady=10, sticky="nsew")
